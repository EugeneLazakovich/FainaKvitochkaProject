        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfPay = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CollectionBaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemCollections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemCollections_Collections_CollectionBaseId",
                        column: x => x.CollectionBaseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemCollections_CollectionBaseId",
                table: "ItemCollections",
                column: "CollectionBaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemCollections_ItemId",
                table: "ItemCollections",
                column: "ItemId");
